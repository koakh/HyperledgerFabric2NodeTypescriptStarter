...
export class MyAssetContract extends Contract {
  ...
  public async createMyAsset(ctx: Context, myAssetId: string, value: string): Promise<void> {
    ...
    // The transaction response is generated automatically by Hyperledger Fabric when the smart
    // contract execution completes. It comprises the states that have been read and those that
    // are to be written if the transaction is successfully committed to the ledger.
    //
    // It's important not to confuse these transaction responses with the return value from the
    // method; they are not the same thing.
